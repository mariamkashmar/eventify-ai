...
export default function CreateEvent() {
  ...
  return;
    ...
    try {
      const res = await fetch("https://eventify-ai-e28l.onrender.com/api/events/create", {
        method: "POST",
        body: formData,
      });
  ...
  const generateDescription = async () => {
    try {
      ...
      const res = await fetch("https://eventify-ai-e28l.onrender.com/api/ai/generate-description", {
        method: "POST",
        headers: {
